  ...
  return (
    <div className="h-screen bg-slate-50 p-0 md:p-0 md:overflow-hidden">
      <div className="w-full h-full flex gap-0 items-stretch">
        ...
        <aside className="hidden md:flex flex-col w-64 bg-slate-50 text-slate-700 py-4 px-4 h-full sticky top-0 overflow-y-auto items-start border-r border-slate-100">
        ...
        {sidebarOpen && (
          <div className="fixed inset-0 z-50 md:hidden flex">
            ...
            />
            <aside className="relative w-64 bg-slate-50 text-slate-700 py-4 px-4 h-full overflow-y-auto border-r border-slate-100">
