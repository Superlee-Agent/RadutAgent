  ...
  return (
    <div className="h-screen bg-slate-50 p-0 md:p-0 md:overflow-hidden">
      <div className="w-full h-full flex gap-0 items-stretch">
        ...
        <aside className="hidden md:flex flex-col w-64 bg-white text-slate-700 pt-2 pb-4 px-4 mt-7 mb-7 h-[calc(100vh-56px)] sticky top-7 overflow-y-auto items-start border-r border-slate-100 shadow-sm">
        ...
        {sidebarOpen && (
          <div className="fixed inset-0 z-50 md:hidden flex">
            ...
            />
            <aside className="relative w-64 bg-white text-slate-700 pt-2 pb-4 px-4 mt-7 mb-7 h-[calc(100vh-56px)] overflow-y-auto border-r border-slate-100">
        ...
        <main className="flex-1 flex justify-center">
          <div className="chat-wrap w-full h-full flex flex-col bg-white">
            <header className="flex items-center gap-3 px-4 py-2 border-b border-slate-100 bg-white">
              <button
                type="button"
            ...
            <form
              className="chat-input flex items-center gap-3 px-6 py-3 border-t bg-white flex-none sticky bottom-0 z-10"
              onSubmit={(e) => {
                e.preventDefault();
                handleSend();
              }}
