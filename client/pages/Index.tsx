  ...
  return (
    <div className="min-h-screen md:h-screen bg-gradient-to-br from-red-50 via-pink-50 to-white p-4 md:p-0 md:overflow-hidden">
      <div className="w-full h-full flex gap-0 items-stretch">
        ...
        <aside className="hidden md:flex flex-col w-64 bg-gradient-to-b from-gray-100 to-pink-50 text-pink-700 pt-2 pb-4 px-4 h-full sticky top-0 overflow-y-auto items-start border-r border-pink-100">
        ...
        <main className="flex-1 flex justify-center">
          <div className="chat-wrap w-full h-full flex flex-col bg-white">
            ...
            <div className="chat-box px-6 py-4 flex-1 overflow-y-auto bg-pink-50">
                ...
                msg.from === "user" ? (
                  ...
                  <div key={i} className="flex justify-end mb-3">
                    <div className="rounded-md overflow-hidden max-w-[70%]">
                      <img src={msg.url} alt="Upload" className="w-full h-auto max-w-[360px] max-h-[300px] object-contain block rounded-md border border-pink-100" />
              ...
              {waiting && (
                <div className="flex items-start mb-2 gap-2" aria-live="polite" aria-label="Bot is typing">
