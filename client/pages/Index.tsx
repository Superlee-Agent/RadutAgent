  ...
  return (
    <div className="min-h-screen md:h-screen bg-gradient-to-br from-red-50 via-pink-50 to-white p-4 md:p-0 md:overflow-hidden">
      <div className="w-full h-full flex gap-0 items-stretch">
        ...
        <aside className="hidden md:flex flex-col w-64 bg-[#0b1220] text-slate-200 py-2 px-4 h-full sticky top-0 overflow-y-auto items-start">
          <div className="flex items-center w-full"><button onClick={handleNewChat} className="w-full py-2 px-3 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-md font-semibold text-sm text-left">+ New chat</button></div>
